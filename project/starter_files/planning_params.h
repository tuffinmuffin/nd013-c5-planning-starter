...
// Planning Constants
#define P_NUM_PATHS 5                  // TODO - Num of paths (goals) - Picked a value may refine later
...
#define P_NUM_POINTS_IN_SPIRAL 24       // TODO - Num of points in the spiral - picked a value may refine later 
